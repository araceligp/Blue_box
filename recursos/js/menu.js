document.addEventListener("DOMContentLoaded", (event) => {
    ...
    let button = document.querySelector(".layout__menu_toggle");
    let icon_bars = document.querySelector(".layout__menu_toggle .fa-bars");
    let icon_xmark = document.querySelector(".layout__menu_toggle .fa-xmark");
